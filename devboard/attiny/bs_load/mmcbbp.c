...
#define	CS_H()		digitalWrite(PIN_CS, 1)	/* Set MMC CS "high" */
#define CS_L()		digitalWrite(PIN_CS, 0)	/* Set MMC CS "low" */
#define CK_H()		digitalWrite(PIN_CK, 1)	/* Set MMC SCLK "high" */
#define	CK_L()		digitalWrite(PIN_CK, 0)	/* Set MMC SCLK "low" */
#define DI_H()		digitalWrite(PIN_MOSI, 1)	/* Set MMC DI "high" */
#define DI_L()		digitalWrite(PIN_MOSI, 0)	/* Set MMC DI "low" */
#define DO			digitalRead(PIN_MISO)	/* Test MMC DO (high:true, low:false) */
